...
const RestaurantesBaresInterior1 = () => {
              ...
              <div className="page mas">
                ...
                <div>
                  {[1, 2, 3, 4].map((index) => (
                    <img
                      key={index}
                      src={`./assets/img/pages/restaurantes-bares/interiores/restaurantes-bares-interior-1-${index}.png`}
                      alt="MAR - SAYULITA"
                  ...
                  <Lightbox
                    ...
                    slides={[
                      ...Array.from({ length: 4 }, (_, i) => ({
                        src: `./assets/img/pages/restaurantes-bares/interiores/restaurantes-bares-interior-1-${((index + i) % 4) + 1
                          }.png`,
                      })),
                    ]}
                  />
...
export default RestaurantesBaresInterior1;