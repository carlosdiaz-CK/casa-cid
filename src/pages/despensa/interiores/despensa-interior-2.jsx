              ...
              <div className="page mas">
                ...
                <div>
                  {[1, 2, 3, 4].map((index) => (
                    <img
                      key={index}
                      src={`./assets/img/pages/despensa/interiores/despensa-interior-2-${index}.jpeg`}
                      alt="PESCADERIA OMAR"
                  ...
                  <Lightbox
                    ...
                    slides={[
                      ...Array.from({ length: 4 }, (_, i) => ({
                        src: `./assets/img/pages/despensa/interiores/despensa-interior-2-${((index + i) % 4) + 1
                          }.jpeg`,
                      })),
                    ]}
                  />
...
export default DespensaInterior2;