              ...
              <div className="page mas">
                ...
                <div>
                  {[1, 2, 3, 4].map((index) => (
                    <img
                      key={index}
                      src={`./assets/img/pages/visitar/interiores/visitar-interior-6-${index}.jpeg`}
                      alt="LUCID"
                  ...
                  <Lightbox
                    ...
                    slides={[
                      ...Array.from({ length: 4 }, (_, i) => ({
                        src: `./assets/img/pages/visitar/interiores/visitar-interior-6-${((index + i) % 4) + 1
                          }.jpeg`,
                      })),
                    ]}
                  />
...
export default VisitarInterior6;