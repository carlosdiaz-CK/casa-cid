              ...
              <div className="page mas">
                ...
                <div>
                  {[1, 2, 3, 4].map((index) => (
                    <img
                      key={index}
                      src={`./assets/img/pages/actividades/interiores/actividades-interior-2-${index}.jpeg`}
                  ...
                  <Lightbox
                    ...
                    slides={[
                      ...Array.from({ length: 4 }, (_, i) => ({
                        src: `./assets/img/pages/actividades/interiores/actividades-interior-2-${((index + i) % 4) + 1
                          }.jpeg`,
                      })),
                    ]}
                  />
...
export default ActividadesInterior2;